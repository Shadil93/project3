...
if(isset($_POST['add_to_cart'])){
  ...
  $sql = mysqli_query($conn , "SELECT *FROM addcart WHERE name='$name'");
...
echo '<script>alert("add to cart")</script>';
    ...
    $insert = mysqli_query($conn, "INSERT INTO addcart (name,price,qty,image)VALUES('$name','$price','$qty','$image')");
...
?>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <ul>
      <li>
      <a href="addcart2.php" value="add_to_cart" class="nav-link scrollto" ><i class="bi bi-cart-fill  "><span><?php echo $row_count?></span></i></a>
  ...
  <div class="card-body mb-1">
    ...
    <h4 class="portfolio-wrap portfolio-info"><?php echo $data['product_name'];?></h4>
    <div class="price"  name="product_price"> $<?php echo $data['product_price'];?></div>

    <input type="hidden" class="from-control" name="name" value="<?php echo $data['name'];?>">
