...
echo '<script>alert("add to cart")</script>';
    ...
    $insert = mysqli_query($conn, "INSERT INTO usercart(name,price,image)VALUES('$productname','$price','$image')");
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
         ...
         <!-- <li><a class="nav-link scrollto" href="#"><span>categories</span><i class="bi bi-chevron-down"></i></a>
          <ul>
          ...
          <li class="dropdown"><a href="#"><span>MY ACCOUNT</span><i class="bi bi-chevron-down"></i></a>
            <ul>
             ...
             <li class="dropdown"><a href="#"> <!--<i class="bi bi-chevron-right"></i--></a>-
                <ul>
         ...
         <li><a class="nav-link scrollto ml-2" href="../logout.php">LOGOUT</a></li>
